    ...
    <nav className="fixed top-0 left-0 w-full flex flex-col bg-black text-white z-50">
      ...
      <div className="flex justify-between items-center border-b border-white px-4 sm:px-8 py-3">
        ...
        <ul className="hidden sm:flex gap-4 sm:gap-6 text-sm">
          ...
          <li><a  download={"Sameer_Chavan_CV.pdf"} className="hidden sm:block text-blue-400 hover:underline">Resume</a></li>
        </ul>
      ...
      {isMenuOpen && (
        <div className="w-full bg-black border-b border-white sm:hidden">
          <ul className="flex flex-col p-4 gap-3">
            ...
            <li><a href="/resume.pdf" className="text-blue-400 hover:underline block py-2">Resume</a></li>
          </ul>
        </div>
      )}
    </nav>
